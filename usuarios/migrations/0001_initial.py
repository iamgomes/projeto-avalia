    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funcao', models.CharField(choices=[('C', 'Controlador Interno'), ('A', 'Auditor')], default='C', max_length=1)),
                ('foto', models.ImageField(blank=True, null=True, upload_to='perfil/')),
                ('entidade', smart_selects.db_fields.ChainedManyToManyField(chained_field='municipio', chained_model_field='municipio', to='entidades.entidade')),
